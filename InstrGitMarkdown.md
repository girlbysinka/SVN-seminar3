...
24.	Вводим команду **git checkout branch** и указываем имя новой ветки (в данном случае text_formatting), чтобы перейти на выбранную ветку.
...
31.	Вводим **git merge branch** и укажем ветку, которую необходимо добавить (в данном случае text_formatting).
